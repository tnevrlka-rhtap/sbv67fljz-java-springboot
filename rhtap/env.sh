...
export GITOPS_REPO_URL=https://github.com/tnevrlka-rhtap/sbv67fljz-java-springboot-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-6gtkq.6gtkq.sandbox568.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-6gtkq.6gtkq.sandbox568.opentlc.com}
